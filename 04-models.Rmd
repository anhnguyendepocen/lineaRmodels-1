...
This section is **optional material**. It contains advanced material that can be skipped upon first reading.
...
We now produce the quantile-quantile plots using the results described in \@ref(qqplot).
