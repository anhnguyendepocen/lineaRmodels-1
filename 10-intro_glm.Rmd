...
```{r cancer_glm}
cancer <- read.table("http://sma.epfl.ch/~lbelzile/math341/cancer.dat", header = TRUE)
print(cancer)
...
```{r smokingglm}
smoking <- read.table("http://sma.epfl.ch/~lbelzile/math341/smoking.dat", header = TRUE)
