...
The interaction between `log(carat)` and `cut`  is significant at the 5% level, idem for `clarity:color`. Keep in mind that adding interactions leads to a large increase in the number of parameters; `clarity:color` would lead to an additional 37 parameters! 
