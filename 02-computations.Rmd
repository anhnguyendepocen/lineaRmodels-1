...
j. Perform an explanatory data analysis. Comment on the most relevant features
...
- Individuals in the data set form a subset of the population of the study and consists of men about to undergo radical prostatectomy. This implies they are in late stages of prostate cancer, as illustrated by the Gleason score;
...
- 0.25 was added to benign prostatic hyperplasia and capsular penetration before taking the log-transform (to get `lbph` and `lcp`);
- It would be better to transform the capsular penetration back to the original scale (because zero means revert back to mean);
