...
\begin{figure}
\includegraphics[width=19.15in]{images/FWL2} \caption{Triangle ABC}\label{fig:fwl3}
\end{figure}

Lastly, the triangle \(BCE\) gives yet another decomposition.

\begin{figure}
\includegraphics[width=5.57in]{images/FWL4} \caption{Triangle BCE}\label{fig:fwl4}
\end{figure}

We can deduce from \ref{fwl4} the latter the formula for least squares.
Looking at the residuals in \ref{fwl2}, we see that the segment \(AC\)
is also the residual from the FWL regression.
